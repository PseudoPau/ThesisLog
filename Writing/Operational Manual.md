...
Architecture is similar to other disciplines in terms of knowledge acquisition and application: there is a significant detachment between frontier institutional research and real world practice. As a result, the knowledge learned in school will likely be of little use in the practice, whereas the critical visual, verbal, legal and financial knowledge necessary to succeed in design practice are not adequately taught as part of a curriculum, but as tacit knowledge that can only be learned from struggles and failures.

What causes the separation between the academic and practice? Why do students always feel painful? What is the best way to publish the idea as architects? Who is our audience? A preliminary purpose of the thesis is to illustrate the complexity and diversity of the present socio-political and techno-political contexts through writing and drawing. Through a literature review and the alignment with development in neuroscience, media and visual art, an updated definition of architecture can be concluded by aligning with frontier neuroscience development as well as a comparison with sibling disciplines such as visual arts. Architects will be positioned as a looker being looked, and a creator being created. The overall purpose of the thesis is to re-clarify the scope of our practice and the range that we can control.
